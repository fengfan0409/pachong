...
request({
  url:'http://www.feixueteam.net/forum.php?mod=post&infloat=yes&action=reply&fid=55&extra=&tid=411&replysubmit=yes&inajax=1',
  method:'POST',
  header:{
    ...
    "Referer": "http://www.feixueteam.net/thread-"+411+"-1-1.html",
